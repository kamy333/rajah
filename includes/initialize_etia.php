...
defined('CONFIG_HEADER')? null : define('CONFIG_HEADER', SITE_ROOT.DS.'Etia'.DS.'layouts'.DS.'config_header.php');
defined('HEADER')? null : define('HEADER', SITE_ROOT.DS.'Etia'.DS.'layouts'.DS.'header.php');
defined('HEADER_PUBLIC')? null : define('HEADER_PUBLIC', SITE_ROOT.DS.'Etia'.DS.'layouts'.DS.'header_public.php');
defined('HEADER_CANVAS')? null : define('HEADER_CANVAS', SITE_ROOT.DS.'Etia'.DS.'layouts'.DS.'header_canvas.php');

defined('FOOTER')? null : define('FOOTER', SITE_ROOT.DS.'Etia'.DS.'layouts'.DS.'footer.php');
defined('FOOTER_PUBLIC')? null : define('FOOTER_PUBLIC', SITE_ROOT.DS.'Etia'.DS.'layouts'.DS.'footer_public.php');

defined('NAV')? null : define('NAV', SITE_ROOT.DS.'Etia'.DS.'layouts'.DS.'nav.php');
defined('NAV_PUBLIC')? null : define('NAV_PUBLIC', SITE_ROOT.DS.'Etia'.DS.'layouts'.DS.'nav_public.php');
defined('NAV_CANVAS')? null : define('NAV_CANVAS', SITE_ROOT.DS.'Etia'.DS.'layouts'.DS.'nav_canvas.php');

defined('SIDEBAR')? null : define('SIDEBAR', SITE_ROOT.DS.'Etia'.DS.'layouts'.DS.'sidebar.php');
defined('SIDEBAR_CANVAS')? null : define('SIDEBAR_CANVAS', SITE_ROOT.DS.'Etia'.DS.'layouts'.DS.'sidebar_canvas.php');
defined('TABLE_MANAGE')? null : define('TABLE_MANAGE', SITE_ROOT.DS.'Etia'.DS.'layouts'.DS.'table_manage.php');


//include(SITE_ROOT.DS.'Etia'.DS.'layouts'.DS."footer.php")


$logo="<span style='color: #0016b0'><b>E</b></span>";
$logo.="<span style='color: green'><b>t</b></span>";
$logo.="<span style='color: red'><b>i</b></span>";
$logo.="<span style='color: darkorchid'><b>a</b></span>";
...
require_once(LIB_PATH.DS.'config_etia.php');
