 ...
 * Time: 11:16 PM
 */
class InvoiceActual extends DatabaseObject{

    protected static $table_name="invoice_actual";

    protected static $db_fields = array('id','project_id', 'project_code','start_date','end_date', 'quantity','unit_price','company_unit_price','category_id', 'category','ref_upload','invoice_id','invoiced','comment');

    protected static $required_fields = array('project_id','start_date','end_date', 'quantity','category_id','unit_price','company_unit_price');

    protected static $db_fields_table_display_short = array('id','project_id', 'project_code','start_date','end_date', 'quantity','unit_price','company_unit_price','price','price_company', 'category','invoice_id','invoiced');

    protected static $db_fields_table_display_full = array('id','project_id', 'project_code','start_date','end_date', 'quantity','unit_price','company_unit_price','price','price_company','category','invoice_id','invoiced');

    protected static $db_field_exclude_table_display_sort=array('price','price_company');
