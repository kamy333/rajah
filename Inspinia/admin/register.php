...
<!--                <h1 class="logo-name">--><?php //echo "<small style='font-size: 0.3em'>". $logo."</small>";?><!--</h1>-->

            </div>
            <h3>Register to <?php echo $logo;?></h3>
            <p>Create account to see it in action.</p>
            <form  autocomplete="off" class="m-t" role="form" id="register_form" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
                <div class="form-group">
                    <input type="text" class="form-control" name="username" placeholder="Username" required <?php echo 'value="'.htmlentities($username, ENT_COMPAT, 'utf-8') . '"';?>>
                </div>

                <div class="form-group">
                    <input type="text" class="form-control" name="first_name" placeholder="First Name" required <?php echo 'value="'.htmlentities($first_name, ENT_COMPAT, 'utf-8') . '"';?>>
        </div>
...
<!--                <input type="password" style="display: none">-->
                ...
                <div class="form-group">
                <input autocomplete="off" type="text" class="form-control" name="last_name" placeholder="Last Name" required="" <?php echo 'value="'.htmlentities($last_name, ENT_COMPAT, 'utf-8') . '"';?>>
        </div>
                <div class="form-group">
                    <input  autocomplete="off" type="email" name="email" class="form-control" placeholder="Email" required"<?php echo 'value="'.htmlentities($email, ENT_COMPAT, 'utf-8') . '"';?>>
                </div>
                <div class="form-group">
                    <input type="password" name="password" class="form-control" placeholder="Password" required autocomplete="new-password" >
                </div>
        <p class="text-muted text-center"><small>If you wish upload your picture?</small></p>
        <div class="form-group">
...
<!--                </div>-->
            ...
            <p class="m-t"> <small>&#xA9;&nbsp;2014 - <?php echo date("Y").'- '.$logo; ?></small> </p>
        </div>
    </div>
