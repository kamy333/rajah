    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <ol class="breadcrumb pull-right">
                ...
                <li class="active">Glyphicon Icons</li>
            </ol>
            <h4 class="page-title">Glyphicon Icons</h4>
        </div>
    </div>
</div>
        ...
        <div class="">
            ...
            <div class="card-box">
                ...
                <div class="row icon-list-demo">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <i class="glyphicon glyphicon-paperclip"></i> glyphicon-paperclipn
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-3">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <i class="glyphicon glyphicon-collapse-up"></i> glyphicon-collapse-top
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-3">
