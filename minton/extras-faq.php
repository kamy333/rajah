...
<div class="row m-t-40">
    <div class="col-lg-9 center-page">
        ...
        <div>
            <div class="question-q-box">Q.</div>
            <h4 class="question">Why do we use it?</h4>
            <p class="answer">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text.</p>
        </div>

        <div>
            <div class="question-q-box">Q.</div>
            <h4 class="question">Where does it come from?</h4>
            <p class="answer">Contrary to popular belief, Lorem Ipsum is not simply random text.
        ...
        <div>
            <div class="question-q-box">Q.</div>
            <h4 class="question">Where can I get some?</h4>
            <p class="answer">There are many variations of passages of Lorem Ipsum available,
        ...
        <div>
            <div class="question-q-box">Q.</div>
            <h4 class="question" data-wow-delay=".1s">How many variations exist?</h4>
            <p class="answer">Lorem ipsum dolor sit amet, in mea nonumes dissentias dissentiunt,
                pro te solet oratio iriure. Cu sit consetetur moderatius intellegam, ius decore
                accusamus te. Ne primis suavitate disputando nam. Mutat convenirete.</p>
        </div>
    </div>
</div>
