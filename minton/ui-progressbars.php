...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="header-title m-t-0"><b>Basic example</b></h4>
                ...
                <div class="col-sm-5 col-sm-offset-1">
                    <h4 class="header-title m-t-0"><b>Striped example</b></h4>
                    <p class="text-muted m-b-30 font-13">
...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="header-title m-t-0"><b>Sizes example</b></h4>
                    <p class="text-muted m-b-30 font-13">
                        Use class <code>.progress-sm</code>,<code>.progress-md</code> and <code>.progress-lg</code>.
                    </p>
                ...
                <div class="col-sm-5 col-sm-offset-1">
                    <h4 class="header-title m-t-0"><b>Animated example</b></h4>
                    <p class="text-muted m-b-30 font-13">
...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="header-title m-t-0"><b>Completed example</b></h4>
                    <p class="text-muted m-b-30 font-13">
                ...
                <div class="col-sm-5 col-sm-offset-1">
                    <h4 class="header-title m-t-0"><b>Stacked example</b></h4>
                    <p class="text-muted m-b-30 font-13">
        ...
        <div class="card-box">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="header-title m-t-0"><b>Animated example</b></h4>
                    <p class="text-muted m-b-30 font-13">
                        Use class <code>.wow</code>,<code>.animated</code> and <code>.progress-animated</code>.
                    </p>
                    <div class="progress">
                ...
                <div class="col-sm-5 col-sm-offset-1">
                    <h4 class="header-title m-t-0"><b>Animated Striped example</b></h4>
                    <p class="text-muted m-b-30 font-13">
                        Use class <code>.wow</code>,<code>.animated</code>,<code>.progress-bar-striped</code> and <code>.progress-animated</code>.
                    </p>
                    <div class="progress">
