...
class PHPExcel_ReferenceHelper
{
	 ...
	 *
	 * @param   string   $a  First column to test.sql (e.g. 'AA')
	 * @param   string   $b  Second column to test.sql (e.g. 'Z')
	 * @return  integer
	 */
	 ...
	 *
	 * @param   string   $a  First cell to test.sql (e.g. 'AA1')
	 * @param   string   $b  Second cell to test.sql (e.g. 'Z1')
	 * @return  integer
	 */
