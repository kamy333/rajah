...
//      $valid->validate_presences($class_name::$required_fields) ;
//      $valid->validate_email('email' );
//      $valid->validate_min_lengths(['pseudo'=>1]);
//      $valid->validate_max_lengths(['pseudo'=>2]);
//      $valid->validate_website('website',true);
...
//            if ($new_item->save()){
//                $session->message("Client: ".$new_item->pseudo." "."has been $text_post with ID (".$user->id .")");
//                $session->ok(true);
//                redirect_to("manage_clients.php");
//            } else {
//                $message("Client: ".$new_item->pseudo." "."$text_post1 failed");
//
//            }
//        }
...
<div class="col-md-7 col-md-offset-2 col-lg-7 col-lg-offset-2">
    ...
    <div class ="background_light_blue">
        ...
        <form name="form_client"  class="form-horizontal" method="post" action="<?php echo $post_link;?>">
            ...
            $class_name::get_form($name,$value);
