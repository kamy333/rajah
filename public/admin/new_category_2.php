...
<div class="col-md-7 col-md-offset-2 col-lg-7 col-lg-offset-2">
    ...
    <a href="<?php echo $class_name::$page_manage ?>" >Manage <?php echo $class_name::$page_manage ?></a> &nbsp;&nbsp;
    <a href="<?php echo $class_name_1::$page_manage ?>" >Manage <?php echo $class_name_1::$page_manage ?></a> &nbsp;&nbsp;
    <a href="<?php echo $class_name_2::$page_manage ?>" >Manage <?php echo $class_name_2::$page_manage ?></a> &nbsp;&nbsp;
