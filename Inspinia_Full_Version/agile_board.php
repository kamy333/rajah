            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="agile_board.php">Agile board</a></li>
        ...
        $(document).ready(function(){
            ...
            $("#todo, #inprogress, #completed").sortable({
                ...
                update: function( event, ui ) {
                    ...
                    $('.output').php("ToDo: " + window.JSON.stringify(todo) + "<br/>" + "In Progress: " + window.JSON.stringify(inprogress) + "<br/>" + "Completed: " + window.JSON.stringify(completed));
                }
            }).disableSelection();
