...
--
-- Stand-in structure for view `transport_model`
--
...
,`inverse_address` tinyint(1)
,`depart` varchar(70)
,`arrivee` varchar(70)
,`prix_course` decimal(10,2)
,`default_depart` varchar(70)
,`default_arrivee` varchar(70)
,`default_price` decimal(10,2)
,`remarque` text
,`chauffeur_id` int(11) unsigned
,`client_habituel` tinyint(1)
,`Lundi` bigint(11) unsigned
,`Mardi` bigint(11) unsigned
,`Mercredi` bigint(11) unsigned
,`Jeudi` bigint(11) unsigned
,`Vendredi` bigint(11) unsigned
,`Samedi` bigint(11) unsigned
,`Dimanche` bigint(11) unsigned
);
-- --------------------------------------------------------

--
-- Stand-in structure for view `transport_model_pivot`
--
CREATE TABLE IF NOT EXISTS `transport_model_pivot` (
`heure` varchar(5)
,`pseudo` varchar(50)
,`web_view` varchar(50)
,`client_id` int(11) unsigned
...
--
-- Stand-in structure for view `transport_model_pivot_visible_no`
--
CREATE TABLE IF NOT EXISTS `transport_model_pivot_visible_no` (
`heure` varchar(5)
,`pseudo` varchar(50)
,`web_view` varchar(50)
,`client_id` int(11) unsigned
...
--
-- Stand-in structure for view `transport_model_pivot_visible_yes`
--
CREATE TABLE IF NOT EXISTS `transport_model_pivot_visible_yes` (
`heure` varchar(5)
,`pseudo` varchar(50)
,`web_view` varchar(50)
,`client_id` int(11) unsigned
...
--
-- Stand-in structure for view `transport_model_visible_no`
--
CREATE TABLE IF NOT EXISTS `transport_model_visible_no` (
`PrimaryKey` varchar(68)
,`heure` varchar(5)
,`jour` tinyint(1)
,`client_id` int(11) unsigned
...
--
-- Stand-in structure for view `transport_model_visible_yes`
--
CREATE TABLE IF NOT EXISTS `transport_model_visible_yes` (
`PrimaryKey` varchar(68)
,`heure` varchar(5)
,`jour` tinyint(1)
,`client_id` int(11) unsigned
...
--
-- Stand-in structure for view `transport_summary_by_course_date_program`
--
CREATE TABLE IF NOT EXISTS `transport_summary_by_course_date_program` (
`course_date` date
,`day_before` date
,`day_after` date
,`date_unix` bigint(10)
...
(6, 'test', '$2y$10$MTI5OWUyNzdiYWEzMjJjO.aOmJYfHzX0QikejYi8qxnA6NrEIGp3q', 'test test', 'test@me.com', 'visitor', 5, 'test1', 'test', '', '', 0, 0, 0, '', '', '', '', '', '', '2016-04-13 07:37:41'),
