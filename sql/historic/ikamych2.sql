...
CREATE TABLE IF NOT EXISTS `chat` (
  ...
  `to_user_id` varchar(255) DEFAULT NULL
   `read` int(11) NOT NULL DEEFAULT 0,
...
INSERT INTO `chat` (`id`, `user_id`, `to_user_id`, `message`) VALUES
(1, 1, '2', 'hi from gva'),
(2, 1, '2', 'new test.sql the feature'),
(3, 2, '2', 'i\'m testing my new mesaages from people i want to know'),
(4, 2, '2', 'hi from gva');
...
(1, 'COLLINE', 1, '', 'COLLINE', 'COLLINE', '', NULL, NULL, NULL, NULL, 'Gen', 'Suisse', NULL, NULL, NULL, 1, '2015-09-25 09:49:22'),
(2, 'AUTRES', 1, '', 'AUTRES', 'AUTRES', '', NULL, NULL, NULL, NULL, 'Gen', 'Suisse', NULL, NULL, NULL, 1, '2015-09-25 09:49:22'),
(3, 'Tour_Patient', 1, '', 'Tour Patient', 'comptabilit', 'Service', NULL, NULL, 'Avenue J.-D. Maillard 3', '1217', 'Meyrin', 'Suisse', NULL, NULL, NULL, 2, '2015-09-25 09:49:22'),
(4, 'Tour_Sang', 0, '', 'Tour Sang', 'comptabilit', 'Service', NULL, NULL, 'Avenue J.-D. Maillard 3', '1217', 'Meyrin', 'Suisse', NULL, NULL, NULL, 3, '2015-09-25 09:49:22'),
(5, 'Carouge_Sang', 0, '', 'Carouge Sang', 'comptabilit', 'Service', NULL, NULL, 'Avenue J.-D. Maillard 3', '1217', 'Meyrin', 'Suisse', NULL, NULL, NULL, 4, '2015-09-25 09:49:22'),
(6, 'BENOIST_FILLE', 0, '', 'BENOIST St', 'BENOIST', 'St', NULL, NULL, 'C', '1231', 'Conches', 'Suisse', NULL, NULL, NULL, 200, '2015-09-25 09:49:22'),
(7, 'BERNASCONI', 0, '', 'BERNASCONI Alexandre', 'BERNASCONI', 'Alexandre', NULL, NULL, 'Chemin des Cr', '1218', 'le Grand-Saconnex', 'Suisse', NULL, NULL, NULL, 200, '2015-09-25 09:49:22');
...
(1, 'kamy', 0, 1461423099, '62.203.13.182', '', '2015-10-13 07:28:31'),
(2, 'EMAIL', 1, 1454839331, '83.78.95.42', '', '2016-02-07 10:02:11'),
(3, '''''=''''or''', 1, 1458077628, '212.126.103.3', '', '2016-03-15 21:33:48'),
(4, 'ADMIN'' OR 1=1#', 1, 1459099024, '160.176.142.249', '', '2016-03-27 17:17:04'),
(5, '''or''''=''', 1, 1459099076, '160.176.142.249', '', '2016-03-27 17:17:56'),
(6, 'gmail', 0, 1459632614, '62.203.13.182', '', '2016-04-02 21:30:14'),
(7, 'admin', 0, 1460711770, '95.211.185.41', '', '2016-04-02 21:31:02'),
(8, 'test', 1, 1460301654, '62.203.13.182', '', '2016-04-10 15:20:54');
...
(2, 'kamy', '$2y$10$ZDJlYTI1OWU3NjA1ODYxZ.CcW4.WWIlMWs6qVo9KvgjjpaonJR0AC', 'Kamran Nafisspour', 'nafisspour@bluewin.ch', 'admin', 1, 'Kamran', 'Nafisspour', '', '', 0, '', '', '', '', '', '', NULL, '2016-04-02 21:32:55'),
(3, 'pablo', '$2y$10$OGEwYmRkMjc5NTNhMTVhNeS9iamczbZH3ag9qt2EXM8EliS2UwUTO', 'Pablo Arza', 'transmed@bluewin.ch', 'employee', 4, NULL, NULL, '', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2015-09-17 23:10:25'),
(4, 'kamy333', '$2y$10$OTAyYzczMGNmMzI2Y2ZjN.faDoYq2/ZSaAK42684GEbpTJ2/Q2Lyq', 'Kamy Manager', 'kamy333@hotmail.com', 'manager', 2, NULL, NULL, '', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2015-09-17 23:10:25'),
(5, 'gmail', '$2y$10$MWU4N2E5MDcwNDRjYjM1Mu2URCsGI9fUp9JCdmPZCX1cYOlmzeu5O', 'Kamy employee', 'kamran.nafisspour@gmail.com', 'employee', 4, '', '', '', '', 0, '', '', '', '', '', '', NULL, '2015-09-17 23:10:25'),
(6, 'test', '$2y$10$MTI5OWUyNzdiYWEzMjJjO.aOmJYfHzX0QikejYi8qxnA6NrEIGp3q', 'test.sql test.sql', 'test@me.com', 'visitor', 5, 'test', 'test', '', '', 0, '', '', '', '', '', '', NULL, '2016-04-13 09:37:41');
...
ADD COLUMN ccy_id int(11) UNSIGNED AFTER amount;
...
ALTER TABLE `myexpense`
ADD CONSTRAINT `myexpense_ibfk_1` FOREIGN KEY (`ccy_id`) REFERENCES `currency` (`id`);
