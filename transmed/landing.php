...
<head>
    ...
    <meta name="author" content="Kamran Nafisspour">
...
<section id="features" class="container services">
    <div class="row">
        ...
        <div class="col-sm-3">
            ...
            <p>Amazing beautiful and intuitive forms. It is known that complicated forms push away subscribers. </p>
            <p><a class="navy-link" href="#" role="button">Details &raquo;</a></p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row m-b-lg">
            <div class="col-lg-12 text-center">
                <div class="navy-line"></div>
                <h1>Contact Us</h1>
                <p>Please contact us so we can arrange an appointment into our premises</p>
            </div>
        </div>
        <div class="row m-b-lg">
            <div class="col-lg-3 col-lg-offset-5">
                <address>
                    <strong><span class="navy"><?php echo $logo; ?></span></strong><br/>
                    68 rue des Vollandes<br/>
                    1207 Genève<br/>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <a href="mailto:ikamy@bluewin.ch" class="btn btn-primary">Send us mail</a>
                <p class="m-t-sm">
