                ...
                <div class="ibox-content mailbox-content">
                    <div class="file-manager">
                        ...
                        <ul class="folder-list m-b-md" style="padding: 0">
                            <li><a href="mailbox.php"> <i class="fa fa-inbox "></i> Inbox <span
                            ...
                            <li><a href="mailbox.php"> <i class="fa fa-file-text-o"></i> Drafts <span
            ...
            <div class="mail-box">
                ...
                <table class="table table-hover table-mail">
                    ...
                    <tr class="unread">
                        ...
                        <td class="mail-subject"><a href="mail_detail.php">Aldus PageMaker including versions of Lorem
                                Ipsum.</a></td>
                        <td class=""></td>
                    ...
                    <tr class="read">
                        ...
                        <td class="mail-ontact"><a href="mail_detail.php">Facebook</a> <span
                                    class="label label-warning pull-right">Clients</span></td>
                        <td class="mail-subject"><a href="mail_detail.php">Many desktop publishing packages and web page
                                editors.</a></td>
                        <td class=""></td>
                    ...
                    <tr class="read">
                        ...
                        <td class="mail-subject"><a href="mail_detail.php">There are many variations of passages of
                                Lorem Ipsum.</a></td>
                        <td class=""></td>
                    ...
                    <tr class="read">
                        ...
                        <td class="mail-ontact"><a href="mail_detail.php">Alex T.</a> <span
                    ...
                    <tr class="read">
                        ...
                        <td class="mail-subject"><a href="mail_detail.php">The standard chunk of Lorem Ipsum used.</a>
                        </td>
                        <td class=""></td>
                    ...
                    <tr class="read">
                        ...
                        <td class="mail-ontact"><a href="mail_detail.php">Patrick Pertners</a> <span
                                    class="label label-info pull-right">Adv</span></td>
                        <td class="mail-subject"><a href="mail_detail.php">If you are going to use a passage of
                                Lorem </a></td>
                        <td class=""></td>
                        <td class="text-right mail-date">May 28</td>
                    </tr>
                    <tr class="read">
                        ...
                        <td class="mail-subject"><a href="mail_detail.php">Humour, or non-characteristic words etc.</a>
                        </td>
                        <td class=""></td>
                    ...
                    <tr class="read">
                        ...
                        <td class="mail-subject"><a href="mail_detail.php">Oor Lorem Ipsum is that it has a more-or-less
                                normal.</a></td>
                        <td class=""></td>
